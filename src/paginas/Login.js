    ...
    axios
      ...
      .then((respuesta) => {
        if (respuesta.data.Estatus === "CORRECTO") {
          ...
          const nivelUsuario = respuesta.data.nivelUsuario; // Obtener el nivel de usuario desde la respuesta
          localStorage.setItem("nivelUsuario", nivelUsuario); // Almacenar el nivel de usuario en localStorage
  ...
  return (
    <>
      ...
      <form className="formulario" onSubmit={acceder}>
        <h1 className="login-ache">Login</h1>
