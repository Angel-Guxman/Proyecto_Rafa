  ...
  return (
    <>
      ...
      <div className="Contacto">
        <form className="formularioContacto" ref={refForm} action="" onSubmit={handelSubmit}>
          ...
          <div className="CajaFormulario">
            <fieldset className="field-name">
              <label className='symbol-required' htmlFor="">Nombre</label>
              <input id="nombre" name="nombre_usuario" type="text" placeholder="Ej: Gerry Dev" required />
            </fieldset>

            <fieldset className="field-email">
              <label className='symbol-required' name='email'>Email</label>
              <input id="email" name="email" type="email" placeholder="Ej: Gerry@gmail.com" required />
            </fieldset>

            <fieldset className="field-message">
              <label className='symbol-required' name='message'>Mensaje</label>
              <textarea maxLength={500} placeholder="Ingresa tu mensaje" name="message" id="message" cols={30} rows={""} />
            </fieldset>
